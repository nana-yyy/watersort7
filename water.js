...
var $author$project$WaterSort4$ChoosingSrc = {$: 'ChoosingSrc'};
var $author$project$WaterSort4$Position = F3(
	function (x, y, c) {
		return {c: c, x: x, y: y};
	});
...
var $author$project$WaterSort4$init = function (_v0) {
	return _Utils_Tuple2(
		{
			completed: true,
			conf: _List_Nil,
			from: A3($author$project$WaterSort4$Position, -1, -1, 0),
			numMove: 0,
			probId: 0,
			state: $author$project$WaterSort4$ChoosingSrc,
			to: A3($author$project$WaterSort4$Position, -1, -1, 0)
		},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$WaterSort4$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$WaterSort4$ChoosingDst = function (a) {
	return {$: 'ChoosingDst', a: a};
};
var $author$project$WaterSort4$RandomDst = F2(
	function (a, b) {
		return {$: 'RandomDst', a: a, b: b};
	});
var $author$project$WaterSort4$RandomSrc = function (a) {
	return {$: 'RandomSrc', a: a};
};
...
var $author$project$WaterSort4$completedBin = function (bin) {
	if (_Utils_eq(bin, _List_Nil)) {
		return true;
	} else {
		var head = A2(
			$elm$core$Maybe$withDefault,
			0,
			$elm$core$List$head(bin));
		return A2(
			$elm$core$List$all,
			function (c) {
				return _Utils_eq(c, head);
			},
			bin);
	}
};
var $author$project$WaterSort4$completed = function (model) {
	return A2($elm$core$List$all, $author$project$WaterSort4$completedBin, model.conf);
};
...
var $author$project$WaterSort4$h = 4;
var $elm$core$Debug$log = _Debug_log;
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$WaterSort4$oto = _Platform_outgoingPort('oto', $elm$core$Basics$identity);
...
var $author$project$WaterSort4$pour = F3(
	function (conf, i, j) {
		var binJ = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			$elm$core$List$head(
				A2($elm$core$List$drop, j, conf)));
		var binI = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			$elm$core$List$head(
				A2($elm$core$List$drop, i, conf)));
		if ((!$elm$core$List$length(binJ)) || (_Utils_eq(
			$elm$core$List$head(binI),
			$elm$core$List$head(binJ)) && (_Utils_cmp(
			$elm$core$List$length(binJ),
			$author$project$WaterSort4$h) < 0))) {
			var srcmodified = _Utils_ap(
				A2($elm$core$List$take, i, conf),
				_Utils_ap(
					_List_fromArray(
						[
							A2($elm$core$List$drop, 1, binI)
						]),
					A2($elm$core$List$drop, i + 1, conf)));
			return _Utils_ap(
				A2($elm$core$List$take, j, srcmodified),
				_Utils_ap(
					_List_fromArray(
						[
							A2(
					...
					A2($elm$core$List$drop, j + 1, srcmodified)));
		} else {
			return conf;
		}
	});
var $author$project$WaterSort4$problems = _List_fromArray(
	[
		_List_fromArray(
		[
			_List_fromArray(
...
var $author$project$WaterSort4$revPour = F3(
	function (conf, i, j) {
		var binJ = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
...
var $author$project$WaterSort4$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SrcSelected':
				var i = msg.a;
				var dummy = A2($elm$core$Debug$log, 'selected', i);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: $author$project$WaterSort4$ChoosingDst(i)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DstSelected':
				var j = msg.a;
				...
				if (_v1.$ === 'ChoosingDst') {
					...
					return (!_Utils_eq(i, j)) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								completed: $author$project$WaterSort4$completed(model),
								conf: A2(
									$elm$core$Debug$log,
									'pour',
									A3($author$project$WaterSort4$pour, model.conf, i, j)),
								from: {
									c: A2(
										$elm$core$Maybe$withDefault,
										0,
										$elm$core$List$head(
											A2(
												...
												_List_Nil,
												$elm$core$List$head(
													A2($elm$core$List$drop, i, model.conf))))),
									x: i,
									y: $elm$core$List$length(
										A2(
											$elm$core$Maybe$withDefault,
											_List_Nil,
											$elm$core$List$head(
										...
										c: A2(
											...
											$elm$core$List$head(
												A2(
													...
													_List_Nil,
													$elm$core$List$head(
														A2($elm$core$List$drop, j, model.conf))))),
										x: j,
										y: $elm$core$List$length(
											A2(
												$elm$core$Maybe$withDefault,
						...
						$author$project$WaterSort4$oto(
							$elm$json$Json$Encode$bool(true))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
				...
				var movableBins = A2(
					...
					A2(
						...
						A2(
							...
							F2(
								function (i, bin) {
									return (($elm$core$List$length(bin) === 1) || (($elm$core$List$length(bin) >= 2) && _Utils_eq(
										A2(
											$elm$core$Maybe$withDefault,
											0,
											$elm$core$List$head(bin)),
										A2(
											...
											0,
											$elm$core$List$head(
												A2($elm$core$List$drop, 1, bin)))))) ? i : (-1);
								}),
							model.conf)));
				return ($elm$core$List$length(movableBins) > 0) ? _Utils_Tuple2(
					model,
					A2(
						$elm$random$Random$generate,
						$author$project$WaterSort4$RandomSrc,
						A2(
							$elm$random$Random$uniform,
							A2(
								$elm$core$Maybe$withDefault,
								-1,
								$elm$core$List$head(movableBins)),
							A2($elm$core$List$drop, 1, movableBins)))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'RandomSrc':
				var x = msg.a;
				var targets = A2(
					$elm$core$Debug$log,
					...
					A2(
						...
						A2(
							...
							F2(
								function (i, bin) {
									return ((($author$project$WaterSort4$h - $elm$core$List$length(bin)) >= 1) && (!_Utils_eq(i, x))) ? i : (-1);
								}),
							model.conf)));
				var dummy = A2($elm$core$Debug$log, 'rand src', x);
				return ($elm$core$List$length(targets) > 0) ? _Utils_Tuple2(
					model,
					A2(
						$elm$random$Random$generate,
						$author$project$WaterSort4$RandomDst(x),
						A2(
							$elm$random$Random$uniform,
							A2(
								$elm$core$Maybe$withDefault,
								-1,
								$elm$core$List$head(targets)),
							A2($elm$core$List$drop, 1, targets)))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'RandomDst':
				var x = msg.a;
				var y = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							conf: A3($author$project$WaterSort4$revPour, model.conf, x, y)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var i = msg.a;
					...
					_Utils_update(
						model,
						{
							...
							conf: A2(
								...
								_List_Nil,
								$elm$core$List$head(
									A2($elm$core$List$drop, i - 1, $author$project$WaterSort4$problems))),
							numMove: 0,
							probId: i
						}),
					$elm$core$Platform$Cmd$none);
...
var $author$project$WaterSort4$animatedSvg = $andrewMacmurray$elm_simple_animation$Simple$Animation$Animated$svg(
	{_class: $elm$svg$Svg$Attributes$class});
var $elm$svg$Svg$trustedNode = _VirtualDom_nodeNS('http://www.w3.org/2000/svg');
var $elm$svg$Svg$rect = $elm$svg$Svg$trustedNode('rect');
var $author$project$WaterSort4$animatedRect = $author$project$WaterSort4$animatedSvg($elm$svg$Svg$rect);
var $author$project$WaterSort4$DstSelected = function (a) {
	return {$: 'DstSelected', a: a};
};
var $author$project$WaterSort4$SrcSelected = function (a) {
	return {$: 'SrcSelected', a: a};
};
var $elm$svg$Svg$clipPath = $elm$svg$Svg$trustedNode('clipPath');
var $elm$svg$Svg$Attributes$clipPath = _VirtualDom_attribute('clip-path');
var $author$project$WaterSort4$color = function (col) {
	switch (col) {
		case 1:
			return 'gray';
		case 2:
...
var $author$project$WaterSort4$fade = F2(
	function (start, stop) {
		return A2(
			$andrewMacmurray$elm_simple_animation$Simple$Animation$steps,
			{
				...
				startAt: _List_fromArray(
					[
						$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$x(start.x),
						$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(start.y),
						A2($andrewMacmurray$elm_simple_animation$Simple$Animation$Property$scaleXY, 1, start.scale)
					])
			},
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$x(stop.x),
							$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(stop.y),
							A2($andrewMacmurray$elm_simple_animation$Simple$Animation$Property$scaleXY, 1, stop.scale)
						]))
				]));
	});
...
var $author$project$WaterSort4$unit = 50;
var $elm$svg$Svg$Attributes$width = _VirtualDom_attribute('width');
var $elm$svg$Svg$Attributes$x = _VirtualDom_attribute('x');
var $elm$svg$Svg$Attributes$y = _VirtualDom_attribute('y');
var $author$project$WaterSort4$binView = F3(
	function (i, bin, model) {
		var waterView = F4(
			function (j, c, l, id) {
				return (_Utils_eq(model.to.x, i) && (!j)) ? A3(
					$author$project$WaterSort4$animatedRect,
					A2(
						$author$project$WaterSort4$fade,
						{scale: 1, x: (2 * (i + 1)) * $author$project$WaterSort4$unit, y: ((($author$project$WaterSort4$h - l) + j) + 2) * $author$project$WaterSort4$unit},
						{scale: 1, x: (2 * (i + 1)) * $author$project$WaterSort4$unit, y: ((($author$project$WaterSort4$h - l) + j) + 1) * $author$project$WaterSort4$unit}),
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$width(
							$elm$core$String$fromInt($author$project$WaterSort4$unit)),
							$elm$svg$Svg$Attributes$height(
							$elm$core$String$fromInt($author$project$WaterSort4$unit)),
							$elm$svg$Svg$Attributes$fill(
							$author$project$WaterSort4$color(c)),
					...
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt((2 * (i + 1)) * $author$project$WaterSort4$unit)),
							$elm$svg$Svg$Attributes$y(
							$elm$core$String$fromInt(((($author$project$WaterSort4$h - l) + j) + 1) * $author$project$WaterSort4$unit)),
							$elm$svg$Svg$Attributes$width(
							$elm$core$String$fromInt($author$project$WaterSort4$unit)),
							$elm$svg$Svg$Attributes$height(
							$elm$core$String$fromInt($author$project$WaterSort4$unit)),
							...
							$author$project$WaterSort4$color(c)),
							$elm$svg$Svg$Attributes$stroke('black'),
							$elm$svg$Svg$Attributes$clipPath('url(#' + (id + ')'))
						]),
					_List_Nil);
			});
		var strokeColor = function () {
			...
			if (_v1.$ === 'ChoosingSrc') {
				...
				var src = _v1.a;
				return _Utils_eq(i, src) ? 'red' : 'black';
			}
		}();
		var msg = function () {
			var _v0 = model.state;
			if (_v0.$ === 'ChoosingSrc') {
				return $author$project$WaterSort4$SrcSelected(i);
			} else {
				var src = _v0.a;
				return $author$project$WaterSort4$DstSelected(i);
			}
		}();
		return A2(
			$elm$svg$Svg$g,
					...
					F2(
						function (j, c) {
							return A4(
								...
								j,
								c,
								$elm$core$List$length(bin),
								'cp' + $elm$core$String$fromInt(i));
						}),
					bin) : _List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt($author$project$WaterSort4$unit)),
								$elm$svg$Svg$Attributes$height(
								$elm$core$String$fromInt($author$project$WaterSort4$h * $author$project$WaterSort4$unit)),
					...
					[
						...
						_List_fromArray(
							[
								...
								'M ' + ($elm$core$String$fromInt((2 * (i + 1)) * $author$project$WaterSort4$unit) + (' ' + ($elm$core$String$fromInt(1 * $author$project$WaterSort4$unit) + ' c 0 -20 -20 -20 -20 0')))),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$svg$Svg$Attributes$d(
										'M ' + ($elm$core$String$fromInt((2 * (i + 1)) * $author$project$WaterSort4$unit) + (' ' + ($elm$core$String$fromInt(1 * $author$project$WaterSort4$unit) + (' l 0 ' + ($elm$core$String$fromFloat(($author$project$WaterSort4$h * $author$project$WaterSort4$unit) - ($author$project$WaterSort4$unit / 2)) + (' c 0 ' + ($elm$core$String$fromFloat(($author$project$WaterSort4$unit * 2) / 3) + (' ' + ($elm$core$String$fromFloat($author$project$WaterSort4$unit) + (' ' + ($elm$core$String$fromFloat(($author$project$WaterSort4$unit * 2) / 3) + (' ' + ($elm$core$String$fromFloat($author$project$WaterSort4$unit) + (' 0 l 0 ' + $elm$core$String$fromFloat((-($author$project$WaterSort4$h * $author$project$WaterSort4$unit)) + ($author$project$WaterSort4$unit / 2)))))))))))))))))
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$svg$Svg$Attributes$d(
								'M ' + ($elm$core$String$fromInt((2 * (i + 1)) * $author$project$WaterSort4$unit) + (' ' + ($elm$core$String$fromInt(1 * $author$project$WaterSort4$unit) + (' l 0 ' + ($elm$core$String$fromFloat(($author$project$WaterSort4$h * $author$project$WaterSort4$unit) - ($author$project$WaterSort4$unit / 2)) + (' c 0 ' + ($elm$core$String$fromFloat(($author$project$WaterSort4$unit * 2) / 3) + (' ' + ($elm$core$String$fromFloat($author$project$WaterSort4$unit) + (' ' + ($elm$core$String$fromFloat(($author$project$WaterSort4$unit * 2) / 3) + (' ' + ($elm$core$String$fromFloat($author$project$WaterSort4$unit) + (' 0 l 0 ' + ($elm$core$String$fromFloat((-($author$project$WaterSort4$h * $author$project$WaterSort4$unit)) + ($author$project$WaterSort4$unit / 2)) + ' c 0 -20 20 -20 20 0')))))))))))))))),
								$elm$svg$Svg$Attributes$stroke(strokeColor),
								$elm$svg$Svg$Attributes$fill('none'),
								$elm$svg$Svg$Attributes$strokeWidth('3')
							]),
...
var $author$project$WaterSort4$PuzzleChosen = function (a) {
	return {$: 'PuzzleChosen', a: a};
};
var $elm$html$Html$button = _VirtualDom_node('button');
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $author$project$WaterSort4$nextButton = function (i) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$svg$Svg$Events$onClick(
				$author$project$WaterSort4$PuzzleChosen(i + 1)),
...
var $author$project$WaterSort4$resetButton = function (i) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$svg$Svg$Events$onClick(
				$author$project$WaterSort4$PuzzleChosen(i)),
				A2($elm$html$Html$Attributes$style, 'font-size', '50px')
			]),
		_List_fromArray(
			[
...
var $author$project$WaterSort4$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_Nil,
				_Utils_ap(
					model.completed ? _List_fromArray(
						[
							$author$project$WaterSort4$nextButton(model.probId)
						]) : _List_fromArray(
						[
							$author$project$WaterSort4$resetButton(model.probId)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									(!(!model.probId)) ? ('Game' + ($elm$core$String$fromInt(model.probId) + (':' + ($elm$core$String$fromInt(model.numMove) + 'move')))) : '')
								]))
						]))),
				A2(
				$elm$svg$Svg$svg,
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$height(
						$elm$core$String$fromInt($author$project$WaterSort4$unit * ($author$project$WaterSort4$h + 1)))
					]),
				_Utils_ap(
					A2(
						$elm$core$List$indexedMap,
						F2(
							function (i, bin) {
								return A3($author$project$WaterSort4$binView, i, bin, model);
							}),
						model.conf),
					_Utils_ap(
						_List_fromArray(
							[
								...
								A2(
									$author$project$WaterSort4$fade,
									{scale: 1, x: (2 * (model.from.x + 1)) * $author$project$WaterSort4$unit, y: (($author$project$WaterSort4$h - model.from.y) + 1) * $author$project$WaterSort4$unit},
									{scale: 0, x: (2 * (model.from.x + 1)) * $author$project$WaterSort4$unit, y: (($author$project$WaterSort4$h - model.from.y) + 2) * $author$project$WaterSort4$unit}),
								_List_fromArray(
									[
										$elm$svg$Svg$Attributes$width(
										$elm$core$String$fromInt($author$project$WaterSort4$unit)),
										...
										$elm$core$String$fromInt($author$project$WaterSort4$unit)),
										$elm$svg$Svg$Attributes$fill(
										$author$project$WaterSort4$color(model.from.c)),
										$elm$svg$Svg$Attributes$stroke('black')
									]),
								_List_Nil)
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$svg$Svg$text(
										(model.completed && (!(!model.probId))) ? '😄' : '')
									]))
							]))))
			]));
};
var $author$project$WaterSort4$main = $elm$browser$Browser$element(
	{init: $author$project$WaterSort4$init, subscriptions: $author$project$WaterSort4$subscriptions, update: $author$project$WaterSort4$update, view: $author$project$WaterSort4$view});
_Platform_export({'WaterSort4':{'init':$author$project$WaterSort4$main(
